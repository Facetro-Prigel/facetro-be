...
const { getter_all, getter, deleteUser, insert, update, upload_image, unnes_image, birthday_image, getUserPresenceLog, reEmbadding } = require('../controller/user')
const { login, googleLogin } = require('../controller/authuser')
...
route.put("/re", authorization('re_embeding'), reEmbadding)
